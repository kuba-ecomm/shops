...
type ShopsServiceClient interface {
	GetStocks(ctx context.Context, in *StockEmpty, opts ...grpc.CallOption) (*StockItems, error)
...
func (c *shopsServiceClient) GetStocks(ctx context.Context, in *StockEmpty, opts ...grpc.CallOption) (*StockItems, error) {
	out := new(StockItems)
	err := c.cc.Invoke(ctx, "/models.ShopsService/GetStocks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShopsServiceServer interface {
	GetStocks(context.Context, *StockEmpty) (*StockItems, error)
...
func (UnimplementedShopsServiceServer) GetStocks(context.Context, *StockEmpty) (*StockItems, error) {
...
func _ShopsService_GetStocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StockEmpty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShopsServiceServer).GetStocks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models.ShopsService/GetStocks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopsServiceServer).GetStocks(ctx, req.(*StockEmpty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShopsService_GetStocks_Handler,
		},
		{
			MethodName: "ShopBy",
