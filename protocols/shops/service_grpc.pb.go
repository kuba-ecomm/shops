...
type ShopsServiceClient interface {
	GetStocks(ctx context.Context, in *StockEmpty, opts ...grpc.CallOption) (*Stocks, error)
...
func (c *shopsServiceClient) GetStocks(ctx context.Context, in *StockEmpty, opts ...grpc.CallOption) (*Stocks, error) {
	out := new(Stocks)
...
type ShopsServiceServer interface {
	GetStocks(context.Context, *StockEmpty) (*Stocks, error)
...
func (UnimplementedShopsServiceServer) GetStocks(context.Context, *StockEmpty) (*Stocks, error) {
